...
public class Database {
	...
	public void createUserTable() {
		...
		String sql = "Create Table users( userid int NOT NULL auto_increment, username text NOT NULL, pass text NOT NULL, PRIMARY KEY(userid))";
	...
	public Object tableExists(String table) {
		// TODO Auto-generated method stub
